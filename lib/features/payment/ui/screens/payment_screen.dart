...
class PaymentScreen extends StatelessWidget {
  const PaymentScreen({super.key, required this.paymentMethods});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _PaymentScreenContent(paymentMethods: paymentMethods),
    );
  }
}

class _PaymentScreenContent extends StatelessWidget {
  const _PaymentScreenContent({required this.paymentMethods});
        ...
        child: TextButton(
          onPressed: () {
            if (state.isProcessComplete) {
             ...
             context.read<CustomKeyboardCubit>() .toggleKeyboardVisibility();
            }
          },
          style: ButtonStyle(
          ...
          child: Text(
            state.isProcessComplete ? "Go to Checkout" : "Toggle Keyboard",
            style: TextStyles.normalTextStyle,
          ),
        ),
      ),
